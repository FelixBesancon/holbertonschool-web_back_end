...
the appropriate page of the dataset, and a method get_hyper that returns
a dictionary containing pagination information and the dataset page.
...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict:
        ...
        Args:
            ...
            page_size (int): The number of items per page.
        Returns:
            dict: A dictionary containing the pagination information and data.
        """
